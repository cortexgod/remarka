        ...
        {cur === "done" && (
          <>
            ...
            <p className="onb-hint">
              Перед следующим созвоном нажми «Записать» или дождись подсказки, когда начнётся звонок в Zoom. Через пару минут после встречи откроется разбор: цифры, транскрипт{appState?.advice_available === false ? " и сравнение с нормами" : " и три правки с цитатами"}.
